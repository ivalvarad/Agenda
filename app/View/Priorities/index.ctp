<div class="priorities index">
	...
	<tr>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $priority['Priority']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $priority['Priority']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
