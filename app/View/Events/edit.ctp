	...
	<div class="row">
		...
		<div class="container-fluid">
			...
			<div align="left" class="col-sm-3">
				<h5><span class="glyphicon glyphicon-remove" aria-hidden="true"></span> &nbsp;<?php echo $this->Form->postLink(__('Eliminar'), array('action' => 'delete', $this->Form->value('Event.id')), array('confirm' => __('Are you sure you want to delete # %s?', $this->Form->value('Event.id')))); ?></h5>
